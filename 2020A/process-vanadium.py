...
LoadEventNexus(Filename='/SNS/CNCS/IPTS-25820/nexus/CNCS_{}.nxs.h5'.format(run_number), OutputWorkspace='CNCS_{}'.format(run_number), LoadMonitors=True)
...
SaveNexus(InputWorkspace="normalized_vanadium", Filename= '/SNS/CNCS/IPTS-25820/shared/van_{}.nxs'.format(run_number)) 

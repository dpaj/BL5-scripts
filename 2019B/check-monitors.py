...
monitor = LoadNexusMonitors('	/SNS/CNCS/IPTS-22728/nexus/CNCS_308538.nxs.h5') #
...
time_range_percentage_window = 0.7
...
tofbin_monitor2_min = int(t_expected_monitor2*(1.-time_range_percentage_window)) 
tofbin_monitor2_max = int(t_expected_monitor2*(1.+time_range_percentage_window)) 
print("peak at monitor2 from times of", tofbin_monitor2_min, "to",tofbin_monitor2_max,"in microseconds")

tofbin_monitor3_min = int(t_expected_monitor3*(1.-time_range_percentage_window)) 
tofbin_monitor3_max = int(t_expected_monitor3*(1.+time_range_percentage_window)) 
print("peak at monitor3 from times of", tofbin_monitor3_min, "to",tofbin_monitor3_max,"in microseconds")

tofbin_monitor4_min = int(t_expected_monitor4*(1.-time_range_percentage_window)) 
tofbin_monitor4_max = int(t_expected_monitor4*(1.+time_range_percentage_window)) 

...
def set_temp(args, value, args2='none', value2=0.0):
    '''
    This function sets the Temperature (K) of a device. IT WAITS FOR THE TEMPERATURE
    TO REACH THE VALUE with a timeout time of 3 hours.
    param   args:   Name of the device (cryo6, vticryo6, ccr10s1, ccr10s2, mag5)
    ...
    if args not in __Aliases_PVs.keys() or ((args2.lower() != 'none') and (args2 not in __Aliases_PVs.keys())):
       ...
       cmds.append(Set(__Aliases_PVs[args], value, completion = True, readback=True, tolerance=temptol, timeout=18000))
    else:
       temptol=caget(__Max_PVs[args])
...
__Aliases_dict={'samplez':movesampleZ,'beaml':beamstopL,'beamr':beamstopR,'huber':movehuber,'ei':ei,
    ...
    'chop5':Chop5freq,'freq5':Chop5freq,'axis1':Axis1,'3sample':Axis1,'axis2':Axis2,'title':title,'comment':comment}
...
__Aliases_cmddict={'samplez':cmdmovesampleZ,'beaml':cmdbeamstopL,'beamr':cmdbeamstopR,'huber':cmdmovehuber,'collimator':collimator,'ei':cmdei,
    ...
    'chop5':cmdChop5freq,'freq5':cmdChop5freq,'axis1':cmdAxis1,'3sample':cmdAxis1,'axis2':cmdAxis2,'title':cmdtitle,'comment':cmdcomment}

__Min_PVs={'samplez':'BL5:Mot:sampleZ.LLM','beaml':'BL5:Mot:beamstopL.LLM','beamr':'BL5:Mot:beamstopR.LLM','huber':'BL5:Mot:huber.LLM','axis1':'BL5:Mot:Sample:Axis1.LLM','3sample':'BL5:Mot:Sample:Axis1.LLM',
...
__Max_PVs={'samplez':'BL5:Mot:sampleZ.HLM','beaml':'BL5:Mot:beamstopL.HLM','beamr':'BL5:Mot:beamstopR.HLM','huber':'BL5:Mot:huber.HLM','axis1':'BL5:Mot:Sample:Axis1.HLM','3sample':'BL5:Mot:Sample:Axis1.HLM',
...
__Aliases_PVs={'samplez':'BL5:Mot:sampleZ','beaml':'BL5:Mot:beamstopL','beamr':'BL5:Mot:beamstopR','huber':'BL5:Mot:huber','ei':'BL5:Chop:Gbl:EnergyReq','wl':'BL5:Chop:Skf1:WavelengthUserReq',
    ...
    'ccr10s2':'BL5:SE:Lakeshore:SETP_S2','vticryo6':'BL5:SE:Cryo:Temp:SETP_S1','cryo6':'BL5:SE:Cryo:Temp:SETP_S2'}

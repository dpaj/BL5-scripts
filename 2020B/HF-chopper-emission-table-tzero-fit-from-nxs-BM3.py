...
E_1p00_runs = range(347220+cut_the_run_range, 347279+1-cut_the_run_range)
E_1p55_runs = range(347280+cut_the_run_range, 347309+1-cut_the_run_range)
E_3p32_runs = range(347310+cut_the_run_range, 347339+1-cut_the_run_range)
E_6p59_runs = range(347340+cut_the_run_range, 347369+1-cut_the_run_range)
E_12p0_runs = range(347370+cut_the_run_range, 347399+1-cut_the_run_range)
E_25p0_runs = range(347400+cut_the_run_range, 347429+1-cut_the_run_range)
E_45p0_runs = list(range(347430+cut_the_run_range, 347438+1)) + list(range(347440, 347459+1-cut_the_run_range))
E_80p0_runs = range(347460+cut_the_run_range, 347489+1-cut_the_run_range)
...
#data from 2019B emission table
plt.plot([1, 1.55, 3.32, 6.59, 12.0, 25.0, 80.0], [246.20578278784342, 212.32765484531592, 171.70984533075625, 197.92436195851224, 137.80986543323161, 110.75952556660832, 13.617713357019284], 'm^', label = '2019B measurement')

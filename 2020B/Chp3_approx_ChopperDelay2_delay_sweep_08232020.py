...
runs = range(346958, 347057+1)

initial_phase_delay_integer = 12400
...
chp2_delay_list = range(initial_phase_delay_integer-scan_range, initial_phase_delay_integer+scan_range, scan_step)

print(chp2_delay_list)
...
flux_res_save(results_folder+'2020B-chp2-test-FINE-', Ei_list, monitor_normalized_intensity_list, monitor_normalized_intensity_perMW_list, vi_list, detector_intensity_list, detector_FWHM_list, DD_opening_list, DD_speed_list)

np.save(results_folder+'2020B-chp2-test-FINE-chp2_delay_list.npy', chp2_delay_list)
...
plt.vlines(3820.71, -1,1, colors = 'green', label = '2019 chp2 delay')
...
plt.vlines(3820.74, -1,1, colors = 'red', label = '2019 chp2 delay')
chp2_period = 1.e6/60./60.
for i in range(-5,20):
    plt.vlines(3820.74 + i*chp2_period, -1,1, colors = 'red', linestyles = 'dashed')

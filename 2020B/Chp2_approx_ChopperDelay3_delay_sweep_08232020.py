...
runs = range(347058, 347157+1)

initial_phase_delay_integer = 12150
...
flux_res_save(results_folder+'2020B-chp3-test-FINE-', Ei_list, monitor_normalized_intensity_list, monitor_normalized_intensity_perMW_list, vi_list, detector_intensity_list, detector_FWHM_list, DD_opening_list, DD_speed_list)

np.save(results_folder+'2020B-chp3-test-FINE-chp3_delay_list.npy', chp3_delay_list)

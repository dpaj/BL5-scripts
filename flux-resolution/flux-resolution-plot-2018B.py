...
intensity_list_1 = np.load(file_prefix_1+'monitor_intensity_list.npy')
intensity_list_3 = np.load(file_prefix_3+'monitor_intensity_list.npy')
intensity_list_0 = np.load(file_prefix_0+'monitor_intensity_list.npy')
...
plt.figure(figsize = [8,10])
ax_flux = plt.gca()
plt.loglog(Ei_list_1, intensity_list_1/1.4, 's-', label = 'dd={0}, speed={1} Hz'.format(dd_num_to_opening[DD_opening_1], speed_request_1) )
plt.loglog(Ei_list_3, intensity_list_3/1.4, '^-', label = 'dd={0}, speed={1} Hz'.format(dd_num_to_opening[DD_opening_1], speed_request_3) )
plt.loglog(Ei_list_0, intensity_list_0/1.4, 'x-', label = 'dd={0}, speed={1} Hz'.format(dd_num_to_opening[DD_opening_1], speed_request_0) )
plt.xlabel('E (meV)')
plt.ylabel('n/s/MW')
plt.legend(loc = 'upper left')
plt.grid(b=True, which='major', color='y', linestyle='-')

...
def flux_res_calc(runs_list):
    ...
    van = Load(Filename='/SNS/CNCS/IPTS-25820/shared/autoreduce/van_347159.nxs', OutputWorkspace='van') #the vanadium normalization file
...
runs_1 = range(347490,347521+1, 1) #condition 1, HF

runs_3 = range(347522,347553+1, 1) #condition 3, AI

runs_0 = range(347554,347585+1, 1) #condition 0, HR
...
flux_res_save(results_folder+'2020B-HF-', Ei_list, monitor_normalized_intensity_list, monitor_normalized_intensity_perMW_list, vi_list, detector_intensity_list, detector_FWHM_list, DD_opening_list, DD_speed_list)
...
flux_res_save(results_folder+'2020B-AI-', Ei_list, monitor_normalized_intensity_list, monitor_normalized_intensity_perMW_list, vi_list, detector_intensity_list, detector_FWHM_list, DD_opening_list, DD_speed_list)
...
flux_res_save(results_folder+'2020B-HR-', Ei_list, monitor_normalized_intensity_list, monitor_normalized_intensity_perMW_list, vi_list, detector_intensity_list, detector_FWHM_list, DD_opening_list, DD_speed_list)
...
def fittingTzero(filename):
    ...
    print(L1, source_to_sample_distance_m)
    ...
    #return Ei and T0
    """
    return Ei, T0, T0_fitted
    
#fittingTzero('/SNS/CNCS/IPTS-20360/nexus/CNCS_287950.nxs.h5') 
#fittingTzero('/SNS/CNCS/IPTS-20360/nexus/CNCS_274475.nxs.h5') # 6.67307102041 meV
...
for this_run in runs_1:
    this_Ei, this_chopper_T0, this_chopper_T0_fitted = fittingTzero(data_folder+'CNCS_{0}.nxs.h5'.format(this_run)) # 36.3311644444 meV
    Ei_1_list.append(this_Ei)
    T0_1_chopper_list.append(this_chopper_T0)
    T0_1_fitted_list.append(this_chopper_T0_fitted)
    print('HF', this_Ei, this_chopper_T0, this_chopper_T0_fitted)
...
for this_run in runs_3:
    ...
    T0_3_chopper_list.append(this_chopper_T0)
    T0_3_fitted_list.append(this_chopper_T0_fitted)
    print('AI', this_Ei, this_chopper_T0, this_chopper_T0_fitted)
...
for this_run in runs_0:
    ...
    T0_0_chopper_list.append(this_chopper_T0)
    T0_0_fitted_list.append(this_chopper_T0_fitted)
    print('HR', this_Ei, this_chopper_T0, this_chopper_T0_fitted)

np.savetxt('T0_Ei_1_list.npy', Ei_1_list)
np.savetxt('T0_1_chopper_list.npy', T0_1_chopper_list)
np.savetxt('T0_1_fitted_list.npy', T0_1_fitted_list)

np.savetxt('T0_Ei_3_list.npy', Ei_3_list)
np.savetxt('T0_3_chopper_list.npy', T0_3_chopper_list)
np.savetxt('T0_3_fitted_list.npy', T0_3_fitted_list)

np.savetxt('T0_Ei_0_list.npy', Ei_0_list)
np.savetxt('T0_0_chopper_list.npy', T0_0_chopper_list)
np.savetxt('T0_0_fitted_list.npy', T0_0_fitted_list)

plt.figure()
plt.plot(Ei_1_list, T0_1_chopper_list)
plt.plot(Ei_1_list, T0_1_fitted_list, 'o', label = 'HF, dd=300Hz')
plt.plot(Ei_3_list, T0_3_fitted_list, 's', label = 'AI, dd=240Hz')
plt.plot(Ei_0_list, T0_0_fitted_list, '^', label = 'HR, dd=180Hz')
plt.legend()
plt.show()
...
van=LoadNexus(Filename="/SNS/CNCS/IPTS-22728/shared/autoreduce/processed_van_318700_no_beamstop_30C.nxs")
...
def powderNexusToMD(filename=None, van='van', tib_min = None, tib_max = None, apply_TIB = '1', T0_fitted = None):
    ...
    LoadInstrument(raw,FileName='/SNS/CNCS/shared/BL5-scripts/2019B2/CNCS_Definition-2019B2.xml', RewriteSpectraMap=False)
...
run_number = 318704
#vfoil = CloneMDWorkspace(powderNexusToMD('/SNS/CNCS/IPTS-22728/nexus/CNCS_{}.nxs.h5'.format(run_number), van, T0_fitted = 200.11))
vfoil = CloneMDWorkspace(powderNexusToMD('/SNS/CNCS/IPTS-22728/nexus/CNCS_{}.nxs.h5'.format(run_number), van, T0_fitted = 200.11))


plotSlice(vfoil, normalization = 2)

...
E_1p00_runs = range(318705+cut_the_run_range, 318734+1-cut_the_run_range)
E_1p55_runs = range(318735+cut_the_run_range, 318764+1-cut_the_run_range)
E_3p32_runs = range(318765+cut_the_run_range, 318794+1-cut_the_run_range)
E_6p59_runs = range(318795+cut_the_run_range, 318824+1-cut_the_run_range)
E_12p0_runs = range(318825+cut_the_run_range, 318854+1-cut_the_run_range)
E_25p0_runs = range(318855+cut_the_run_range, 318884+1-cut_the_run_range)
...
plt.plot([1,1.55,3.32, 6.59, 12.0, 25.0, 80.0], [236.00, 226.00, 182.61, 187.68, 156.92, 124.22, 13.62], 'mx', label = '2019B measurement')

...
E_1p00_runs = range(299294+cut_the_run_range, 299323+1-cut_the_run_range)
E_1p55_runs = range(299324+cut_the_run_range, 299353+1-cut_the_run_range)
E_3p32_runs = range(299354+cut_the_run_range, 299383+1-cut_the_run_range)
E_6p59_runs = range(299384+cut_the_run_range, 299413+1-cut_the_run_range)
E_12p0_runs = range(299414+cut_the_run_range, 299443+1-cut_the_run_range)
E_25p0_runs = range(299444+cut_the_run_range, 299473+1-cut_the_run_range)
E_45p0_runs = range(299474+cut_the_run_range, 299503+1-cut_the_run_range)
E_80p0_runs = range(299521+cut_the_run_range, 299551+1-cut_the_run_range-2)
